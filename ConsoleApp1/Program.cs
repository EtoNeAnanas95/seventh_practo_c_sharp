...
namespace ConsoleApp1
{
    internal class Program
    {
        ...
        //надеюсь мне не дадут по шапке за этот анекдот
        //умоляю, не ставьте два
        //любой сигнал и я удаляю это отсюда

        
        //Заходит как-то гномик в магазин и говорит продавщице: "Дайте мне пожалуйста 25 грамм сыра."
        //А продавщица ему отвечает: "А ты не лопнешь?"
        //-Пошла нахуй, шлюха драная. - отвечает ей гномик
    }
}
